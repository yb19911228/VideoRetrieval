...
void CMFC_DEMODlg::OnBnClickedOpenImg()
{
	...
	image = cvLoadImage("D:\\11.jpg",1); //显示图片
...
void CMFC_DEMODlg::OnBnClickedLoadImg()
{
	...
	IplImage* TheImage;
	CFileDialog dlg(true,_T("*.bmp"),NULL,OFN_FILEMUSTEXIST|OFN_PATHMUSTEXIST|OFN_HIDEREADONLY,_T("image file(*.bmp;*.jpg)|*.bmp;*.jpg|All Files(*.*)|*.*|"),NULL);//弹出选择图片对话框
